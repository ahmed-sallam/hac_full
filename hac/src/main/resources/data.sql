...
VALUES ('أفغانستان', 'Afghanistan'),
       ...
       ('زامبيا', 'Zambia'),
       ('زيمبابوي', 'Zimbabwe');
INSERT INTO machine_parts (name_ar,
                           name_en,
                           created_at,
                           updated_at,
                           is_active)
...
-- Inserting data into the store_locations table virtual store
INSERT INTO stores (name_ar,
                    ...
                    is_active,
                    is_virtual)
VALUES ('customers', 'customers', 'virtual', 'virtual', NOW(), NOW(),
        TRUE, TRUE),
...
INSERT INTO store_locations (name_ar,
                             name_en,
                             store_id,
                             created_at,
                             updated_at,
                             is_active)
VALUES ('موقع 1', 'Location 1', 4, NOW(), NOW(), TRUE),
       ('موقع 2', 'Location 2', 4, NOW(), NOW(), TRUE),
       ('موقع 3', 'Location 3', 5, NOW(), NOW(), TRUE),
       ('موقع 4', 'Location 4', 6, NOW(), NOW(), TRUE);
...
VALUES (1,
       ...
       (7,
        ...
        NOW(),
        TRUE),
       (8, 'Dsg', 'Dsg', 'Dsg', 1, NOW(), NOW(), TRUE),
       (9, 'Dsm', 'Dsm', 'Dsm', 3, NOW(), NOW(), TRUE);
-- INSERT INTO roles (id, name)
-- VALUES (1, 'ADMIN'),
--         (2, 'USER');
