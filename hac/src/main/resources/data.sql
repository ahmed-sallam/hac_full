...
VALUES (1, 'admin',
        '$2a$10$wy6yy53B53sRgVJ/0q7u3OhJGX91obQDSYp1UqXqOv5c.3XxCQb7u');
...
VALUES ('الكبائن', 'Cabs', NOW(), NOW(), TRUE),
...
INSERT INTO stores (name_ar, name_en, city_ar, city_en, created_at, updated_at,
                    is_active)
VALUES ('مخازن جدة', 'Jeddah Stores', 'جدة', 'Jeddah', NOW(), NOW(), TRUE),
       ('مخازن مكة', 'Mecca Stores', 'مكة', 'Mecca', NOW(), NOW(), TRUE),
       ('مخازن الرياض', 'Riyadh Stores', 'الرياض', 'Riyadh', NOW(), NOW(),
        TRUE);

-- Inserting data into the store_locations table
INSERT INTO store_locations (name_ar, name_en, store_id, created_at, updated_at,
                             is_active)
VALUES ('موقع 1', 'Location 1', 1, NOW(), NOW(), TRUE),
...
INSERT INTO brands (id, name_ar, name_en, code, main_brand_id, created_at,
                    updated_at, is_active)
VALUES (1, 'كاتربيلر', 'Caterpillar', 'CAT', NULL, NOW(), NOW(), TRUE),
...
INSERT INTO currencies (name, code, exchange_rate, created_at, updated_at,
                        is_active)
