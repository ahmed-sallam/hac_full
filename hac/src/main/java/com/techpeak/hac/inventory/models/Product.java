...
@Table(name = "products", uniqueConstraints = {@UniqueConstraint(columnNames = {"product_number", "main_brand_id", "sub_brand_id", "country_id"})},
        indexes = {@Index(name = "idx_product_number", columnList = "product_number"), @Index(name = "idx_main_brand_id", columnList = "main_brand_id"),
                @Index(name = "idx_sub_brand_id", columnList = "sub_brand_id")}
)
@Setter
@Getter
@AllArgsConstructor
